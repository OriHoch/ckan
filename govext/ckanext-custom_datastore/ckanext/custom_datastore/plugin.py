...
import ckanext.custom_datastore.logic.action as action
import ckanext.custom_datastore.logic.auth as auth
...
from ckanext.custom_datastore.backend.postgres import DatastorePostgresqlBackend
