...
import ckanext.custom_datapusher.logic.action as action
import ckanext.custom_datapusher.logic.auth as auth
import ckanext.custom_datapusher.helpers as helpers
...
class CustomResourceDataController(base.BaseController):
    ...
    def resource_data(self, id, resource_id):
        ...
        if toolkit.request.method == 'POST':
            ...
            core_helpers.redirect_to(
                controller='ckanext.custom_datapusher.plugin:CustomResourceDataController',
...
class CustomDatapusherPlugin(p.SingletonPlugin):
